...
#define rotate1 'q'
#define rotate2 'x'
#define rrotate 'e' // Rotate counterclockwise. Cannot detect control, sorry!
#define rotate180 'w'
#define left 'a'
#define right 'd'
#define softdrop 's'
#define harddrop 'x' // space
#define holdKey 'c' // I also cannot detect shift. Sorry about that!

// Other

#define len 16 // length of grid
#define wid 16 // width of grid
#define nextLen 6 // how many next tetrominoes are shown
#define dropTime 50 // time it takes for each tetromino to fall, in microseconds
                      // could not find a good standard for this, so adjust as needed
#define lockDelay 100 // lock delay time, in microseconds.
...
#define secondsToStart 0 // number of seconds before game starts
